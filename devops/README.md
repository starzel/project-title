...
You need either a Ubuntu or Debian based system for mika.starzel.de, enable SSH, and install a supported version of Python 3 on that system.
...
Deploy the stack defined in `devops/stacks/mika.starzel.de.yml` to the remote server with:
